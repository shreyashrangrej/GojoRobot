...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"GojoRobot/modules/{shortname}.py")
        name = "GojoRobot.modules.{}".format(shortname)
        ...
        mod.GojoRobot = GojoRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["GojoRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "GojoRobot/modules/*.py"
